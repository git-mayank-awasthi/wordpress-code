<?php
/**
 * Template Name: EMHS REGISTRATION
 * Version: 1.0
...
//    die('Under testing');
    ...
    if ($form_data['entry_id'] == 171 || $form_data['entry_id'] == 173   ) {
        $class = 'rotateimg180';
    }
    ?>       
...
<div class='mainhdfkm'>&nbsp; REGISTRATION FORM (RESIDENTIAL)</div>
<table>
    <tr> 
        <td>
            <table>
                <tr>
                    <td class="ftd">
                        Form No. : <input style="width:110px;border:1px solid;height: 25px;" type="name" value=''/> <span style="font-size: 10px">(For office use only)</span>
                        <br> 
                        Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:     
        ...
        <td align='right'><img class='<?php echo $class; ?>'  width="100" height="100" src="<?php echo $form_data['field']['40.Upload Photo']['url']; ?>"></td>
    </tr>
</table>
<br>
<div class="headingfkm ftd"><b>Child's Personal Information<b></div>
            ...
            <table class='table ftd'>
                ...
                if ($form_data['field']['Class in which admission is required'] == 'XI') {
                    if (!empty($form_data['field']['72.Kindly choose your stream'])) {
                        ?>
                        <tr>
                            <td colspan="2">
                                Your Stream :&nbsp;&nbsp; <b><?php echo strtoupper($form_data['field']['72.Kindly choose your stream']); ?></b>
                            </td>
                        </tr>
                        <?php
                    }
                ...
                if ($form_data['field']['Class in which admission is required'] == 'IX') {
                    if (!empty($form_data['field']['73.Kindly choose from the following subjects'])) {
                        ?>
                        <tr>
                            <td colspan="2">
                                Preferred Subject :&nbsp;&nbsp; <b><?php echo strtoupper($form_data['field']['73.Kindly choose from the following subjects']); ?></b>
                            </td>
                        </tr>
                        <?php
                    }
            ...
            <ol class="ftd" style="font-size: 12px; list-style-type:none!important; ">
                <li>
                    I hereby certify that the above information is true and correct.
                </li>
                <li>
                    Any wrong information given will result in the cancellation of admission.
                </li>
                <li>
                    I hereby request the Principal to register the name of my child without any assurance whatsoever, decision of the school being final and binding. I will be depositing the registration fee of &#8377;2000/- (Non Refundable).
                </li>
            </ol>